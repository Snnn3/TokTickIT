...
> Fill PR rows as Sprint 3 progresses. Every feature branch merges into `lab3-staging` then `main` via reviewed PRs.
...
TBD — quote each review verbatim, then record the response and fix commit.
...
TBD — keep all rounds plus partner replies.
